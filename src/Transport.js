        ...
        <body className='body'>
            ...
            <section className="first">
                <div className="text">
                    ...
                    <p>Avec le réseau Corolis, la communauté d’agglomération du Beauvaisis met tout en œuvre pour vous simplifier la vie et vous offrir un réseau de transports urbains toujours plus efficace.<br/>Le réseau Corolis a été entièrement modernisé pour devenir un réseau plus clair, lisible et efficace. Ce nouveau réseau, digne d’une commune comme Beauvais, a été lancé le 29 août 2016. </p>
                </div>
            </section>
            ...
            <section className="second">
                <div className="text">
                    ...
                    <p>Depuis janvier 2015, le réseau de transports urbains Corolis propose le ticket BUT, un billet unique de transport à 1€ par jour seulement.<br/>
            ...
            <section className="third">
                <div className="text">
                    ...
                    <p>
                    Soucieuse de son empreinte écologique, la communauté d’agglomération du Beauvaisis, propriétaire des bus et minibus urbains, a choisi la technologie hybride diesel/électrique.<br/>
